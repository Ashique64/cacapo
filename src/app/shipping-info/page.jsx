            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="p-6 sm:p-8 bg-[#f9f8f6] border border-card-border space-y-4 hover:border-accent/40 transition-colors duration-500 relative">
                ...
                <p className="text-muted-text text-xs font-light leading-relaxed">
                  ...
                  <br /><br />
                  • <strong className="text-foreground font-semibold">Standard Shipping:</strong> 5 to 7 business days.
                  <br />
                  • <strong className="text-foreground font-semibold">Express Shipping:</strong> 2 to 3 business days.
                  <br /><br />
              ...
              <div className="p-6 sm:p-8 bg-[#f9f8f6] border border-card-border space-y-4 hover:border-accent/40 transition-colors duration-500 relative">
                ...
                <p className="text-muted-text text-xs font-light leading-relaxed">
                  Domestic shipping is free on all orders above <strong className="text-foreground font-semibold">₹10,000</strong>. For orders below this threshold, a flat delivery and handling fee of <strong className="text-foreground font-semibold">₹50</strong> is calculated at checkout.
                </p>
              </div>
