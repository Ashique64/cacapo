...
export default function Marquee() {
  ...
  return (
    <div className="lg:hidden w-full overflow-hidden bg-marquee-bg/40 backdrop-blur-md border-y border-marquee-border py-3.5 sm:py-4 select-none relative z-20">
      {/* Side Vignette Fades */}
      ...
      <div className="animate-marquee flex items-center gap-12 whitespace-nowrap">
        {listItems.map((item, index) => (
          <div key={index} className="flex items-center gap-10 text-marquee-text">
            <span className="text-[10px] sm:text-xs font-bold tracking-[0.25em] font-mono uppercase text-marquee-text">
              {item}
            </span>
