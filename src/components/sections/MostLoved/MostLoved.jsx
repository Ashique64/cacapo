...
function ProductCard({ product }) {
  ...
  return (
    <div
      ...
      className="shrink-0 w-full lg:w-[32vw] h-[44vh] sm:h-[50vh] md:h-[35vh] lg:h-[75vh] flex flex-col justify-between p-4 md:p-4 lg:p-6 bg-card-bg border border-card-border rounded-none backdrop-blur-xs relative overflow-hidden group hover:border-accent hover:ring-1 hover:ring-accent/50 transition-all duration-500 hover:shadow-[0_10px_30px_rgba(0,0,0,0.04)]"
    >
      {/* Ambient Background Light */}
      <div className="absolute top-0 right-0 w-32 h-32 bg-accent/5 blur-[50px] rounded-full pointer-events-none" />

      {/* Product Image Panel */}
      <div className="w-full h-[62%] lg:h-1/2 rounded-none overflow-hidden relative border border-card-border">
        <div className="absolute inset-0 bg-linear-to-b from-transparent to-background/30 z-2 pointer-events-none" />
            ...
            {images.map((img, i) => (
              <div key={i} className="relative w-full h-full shrink-0">
                <Image
                  ...
                  className="object-cover transform scale-100 group-hover:scale-102 transition-transform duration-1000"
        ...
        {/* Sold Out Overlay */}
        {isCardOutOfStock && (
          <span className="absolute top-4 left-4 bg-background/85 border border-red-500/30 text-red-500 text-[8px] font-extrabold tracking-widest px-2.5 py-1 uppercase z-10 font-mono">
            Sold Out
          </span>
        )}
        ...
        <button
          ...
          className="absolute top-4 right-4 z-10 p-2.5 bg-white/80 backdrop-blur-xs border border-zinc-200/80 hover:bg-white text-zinc-800 hover:text-accent hover:border-accent/40 rounded-full transition-all duration-300 pointer-events-auto cursor-pointer group/wishlist active:scale-90"
        >
      ...
      <div className="flex flex-col grow justify-between mt-3 md:mt-3 lg:mt-6">
        <div>
          <div className="mb-2">
            <Link href={`/shop/${product.slug}`} className="hover:text-accent transition-colors block">
              <h3 className="text-sm sm:text-base md:text-base lg:text-xl font-bold tracking-wide text-foreground transition-colors truncate lg:whitespace-normal">
                {product.name}
              </h3>
            </Link>
          ...
          <div className="text-xl sm:text-2xl md:text-xl lg:text-2xl font-semibold tracking-tight text-accent font-mono mt-2 md:mt-1 lg:mt-3 flex items-baseline gap-1.5 flex-wrap">
            ...
            {displayOriginalPrice && (
              <span className="text-xs sm:text-sm font-semibold font-mono text-muted-text line-through">
                ₹{displayOriginalPrice}
              </span>
            )}
          </div>
        ...
        <div className="mt-3 lg:mt-6">
          <Link
            ...
            className="w-full py-3 text-[10px] sm:text-xs font-semibold tracking-[0.25em] rounded-none transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer bg-foreground text-background border border-foreground group-hover:bg-accent group-hover:border-accent group-hover:text-white hover:bg-transparent hover:text-foreground hover:border-foreground"
          >
...
export default function ProductShowcase({ initialProducts }) {
  ...
  return (
    <div ref={triggerRef} className="bg-background select-none w-full relative overflow-hidden">
        ...
        <>
          ...
          <div className="lg:hidden w-full relative">
            ...
            <div className="flex flex-col items-center mt-4 mb-12">
              <div className="w-24 h-px bg-card-border relative">
                <div
              ...
              <div className="flex gap-2 mt-3 text-[9px] tracking-widest text-muted-text font-mono">
          ...
          <div
            ref={sectionRef}
            className="hidden lg:flex lg:flex-row lg:items-center lg:justify-start lg:relative lg:px-[10vw] lg:gap-12 lg:w-fit lg:bg-background lg:py-0 lg:overflow-x-visible lg:max-w-none lg:mx-0 lg:h-screen"
          ...
          >
            ...
            <div className="lg:shrink-0 lg:w-[45vw] lg:flex lg:flex-col lg:justify-center lg:pr-12">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-6xl font-bold tracking-tight text-foreground uppercase leading-none">
                LATEST <span className="text-accent">RELEASES</span>
              </h2>
            ...
            <div className="lg:shrink-0 lg:w-[50vw] lg:flex lg:flex-col lg:justify-center lg:pl-12">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground tracking-tight leading-none uppercase">
                END OF <br />
